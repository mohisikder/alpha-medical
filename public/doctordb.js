const doctordb= [
   {
      ...
      degree:"MBBS, MCPS, ACORL, PhD, MSc (Audiology), FCPS (ENT), FRCS (Glasgow)",
      specialty:"Ear, Nose & Throat Specialist & Head Neck Surgeon",
   ...
   },
   {
      ...
      specialty:"Expert Dermatologist, Sexologist & Venereologist",
   ...
   },
   {
      ...
      specialty:"Gastroenterology, Medicine & Liver Diseases Specialist",
      workplace:"National Hospital, Chittagong"
   },
   {
      id: 2200,
      name:"Prof. Dr. Syed Atiqul Haq",
      img:"https://www.doctorbangladesh.com/wp-content/uploads/dr-male-75x85.jpg",
      degree:"MBBS, FCPS (Medicine), FRCP, MD (Rheumatology)",
      specialty:"Rheumatology & Medicine Specialist",
      workplace:"Bangabandhu Sheikh Mujib Medical University Hospita"
   },
   {
      id: 2200,
      name:"Prof. Dr. Quazi Deen Mohammad",
      img:"https://www.doctorbangladesh.com/wp-content/uploads/dr-male-75x85.jpg",
      degree:"MBBS, MD (Neurology), FCPS (Medicine), Fellow in Neurology (USA)",
      specialty:"Neurology & Medicine Specialist",
   ...
   },
   {
      ...
      specialty:"Brain, Stroke, Nerve, Medicine & Neuromedicine Specialist",
   ...
   },
   {
      ...
      img:"https://www.doctorbangladesh.com/wp-content/uploads/dr-male-75x85.jpg",
      degree:"MBBS, FCPS, MD, PHD, FRCP (GLASGOW)",
      specialty:"Skin & Sexual Diseases Specialist",
      workplace:"Chittagong Medical College & Hospital"
   },
   {
      id: 2200,
      ...
      img:"https://www.doctorbangladesh.com/wp-content/uploads/dr-male-75x85.jpg",
      degree:"MBBS, MSc (Gastro), MD (Hepatology), FACG (USA), FICP (India), FRCP (Ireland), FRCP (UK)",
   ...
   },
   {
      ...
      img:"https://www.doctorbangladesh.com/wp-content/uploads/dr-male-75x85.jpg",
      degree:"MBBS, DDV (Vienna), AFICA (USA), FRCP (Glasgow)",
      specialty:"Skin, Allergy & Sexual Diseases Specialist",
